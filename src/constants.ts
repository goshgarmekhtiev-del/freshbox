...
export const JUICY_IMAGES = {
  // Hero section main image - premium fruit box
  box1: 'https://sinygofavafuuahhgwll.supabase.co/storage/v1/object/public/directory%20after%20compression/basic.webp', 
...
export const PRODUCTS: Product[] = [
  // --- SMALL (S) ---
  {
    ...
    price: 1900,
    image: 'https://sinygofavafuuahhgwll.supabase.co/storage/v1/object/public/directory%20after%20compression/S1.webp',
    tag: 'Хит продаж'
  },
  {
    id: 's2',
    ...
    price: 2200,
    image: 'https://sinygofavafuuahhgwll.supabase.co/storage/v1/object/public/directory%20after%20compression/S2.webp',
    tag: 'Тропики'
  },
  {
    id: 's3',
    ...
    price: 1800,
    image: 'https://sinygofavafuuahhgwll.supabase.co/storage/v1/object/public/directory%20after%20compression/S3.webp',
    tag: 'Классика'
  },
  {
    id: 's4',
    ...
    price: 2500,
    image: 'https://sinygofavafuuahhgwll.supabase.co/storage/v1/object/public/directory%20after%20compression/S4.webp',
    tag: 'ЗОЖ'
  },
  {
    id: 's5',
    ...
    price: 2600,
    image: 'https://sinygofavafuuahhgwll.supabase.co/storage/v1/object/public/directory%20after%20compression/S5.webp',
    tag: 'Новинка'
  },
  ...
  // --- MEDIUM (M) ---
  {
    ...
    price: 3500,
    image: 'https://sinygofavafuuahhgwll.supabase.co/storage/v1/object/public/directory%20after%20compression/M1.webp',
    tag: 'Для семьи'
  },
  {
    id: 'm2',
    ...
    price: 4200,
    image: 'https://sinygofavafuuahhgwll.supabase.co/storage/v1/object/public/directory%20after%20compression/M2.webp',
    tag: 'Хит продаж'
  },
  {
    id: 'm3',
    ...
    price: 3900,
    image: 'https://sinygofavafuuahhgwll.supabase.co/storage/v1/object/public/directory%20after%20compression/M3.webp',
    tag: 'Detox'
  },
  {
    id: 'm4',
    ...
    price: 3800,
    image: 'https://sinygofavafuuahhgwll.supabase.co/storage/v1/object/public/directory%20after%20compression/M4.webp',
    tag: 'В офис'
  },
  {
    id: 'm5',
    ...
    price: 4500,
    image: 'https://sinygofavafuuahhgwll.supabase.co/storage/v1/object/public/directory%20after%20compression/M5.webp',
    tag: 'Подарок'
  },
  {
    id: 'm6',
  ...
  // --- LARGE (L) ---
  {
    ...
    price: 5500,
    image: 'https://sinygofavafuuahhgwll.supabase.co/storage/v1/object/public/directory%20after%20compression/L1.webp',
    tag: 'Праздник'
  },
  {
    id: 'l2',
    ...
    price: 7500,
    image: 'https://sinygofavafuuahhgwll.supabase.co/storage/v1/object/public/directory%20after%20compression/L2.webp',
    tag: 'VIP Новинка'
  },
  {
    id: 'l3',
    ...
    price: 5000,
    image: 'https://sinygofavafuuahhgwll.supabase.co/storage/v1/object/public/directory%20after%20compression/L3.webp',
    tag: 'Для семьи'
  },
  {
    id: 'l4',
    ...
    price: 5200,
    image: 'https://sinygofavafuuahhgwll.supabase.co/storage/v1/object/public/directory%20after%20compression/L4.webp',
    tag: 'ЗОЖ'
  },
  {
    id: 'l5',
    ...
    price: 7000,
    image: 'https://sinygofavafuuahhgwll.supabase.co/storage/v1/object/public/directory%20after%20compression/L5.webp',
    tag: 'WOW-эффект'
  }
];
