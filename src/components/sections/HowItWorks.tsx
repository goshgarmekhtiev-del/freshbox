  ...
  return (
    <SectionLight id="how-it-works" className="reveal">
      <div className="text-center mb-12 md:mb-20">
        <span className="text-brand-overline">Все просто</span>
        <h2 className="text-brand-h2 mt-4">Как мы работаем</h2>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 relative">
        ...
        {steps.map((step, idx) => (
          ...
          >
            ...
            <h3 className="text-brand-h3 mb-4">{step.title}</h3>
            <p className="text-brand-body px-4">{step.desc}</p>
          </div>
        ))}
      </div>
    </SectionLight>
