...
const CheckoutForm = forwardRef<CheckoutFormHandle, CheckoutFormProps>(
  ...
  if (isCompact) {
    return (
      <form onSubmit={handleSubmit} className="w-full">
        <div className="w-full flex flex-col gap-6 lg:grid lg:grid-cols-[minmax(0,1.8fr)_minmax(320px,1fr)] lg:items-start">
          ...
          <div className="order-2 lg:order-1 flex flex-col gap-6 w-full">
            ...
            <div className="p-4 rounded-2xl bg-gradient-to-br from-emerald-50/50 to-lime-50/50 border border-emerald-100 space-y-4">
              <div className="flex items-center gap-3">
                ...
                <h4 className="text-lg font-black text-brand-text">Контактные данные</h4>
              </div>
          ...
          <div>
            ...
            <div className="p-4 rounded-2xl bg-gradient-to-br from-amber-50/50 to-orange-50/50 border border-amber-100 space-y-4">
              <div className="flex items-center gap-3">
                ...
                <h4 className="text-lg font-black text-brand-text">Адрес доставки</h4>
              </div>
        ...
        <div>
          ...
          >
            ...
            <div className="p-4 rounded-2xl bg-gradient-to-br from-blue-50/50 to-indigo-50/50 border border-blue-100 space-y-4">
              <div className="flex items-center gap-3">
                ...
                <h4 className="text-lg font-black text-brand-text">Способ оплаты</h4>
              </div>
          ...
          <aside className="order-1 lg:order-2 lg:sticky lg:top-24 flex flex-col gap-4 lg:w-[320px] lg:flex-shrink-0 lg:justify-start">
  ...
  // Full mode (not compact) - single column layout
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      {/* Section 1: Customer Info */}
      <div className="p-5 rounded-2xl bg-gradient-to-br from-emerald-50/50 to-lime-50/50 border border-emerald-100 space-y-4">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-brand-accent to-brand-accent-dark flex items-center justify-center text-white">
            <User size={20} strokeWidth={2.5} />
          </div>
          <h4 className="text-xl font-black text-brand-text">Контактные данные</h4>
        </div>
      ...
      <div className="p-5 rounded-2xl bg-gradient-to-br from-amber-50/50 to-orange-50/50 border border-amber-100 space-y-4">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-brand-yellow to-brand-accent flex items-center justify-center text-white">
            <MapPin size={20} strokeWidth={2.5} />
          </div>
          <h4 className="text-xl font-black text-brand-text">Адрес доставки</h4>
        </div>
      ...
      <div className="p-5 rounded-2xl bg-gradient-to-br from-blue-50/50 to-indigo-50/50 border border-blue-100 space-y-4">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center text-white">
            <CreditCard size={20} strokeWidth={2.5} />
          </div>
          <h4 className="text-xl font-black text-brand-text">Способ оплаты</h4>
        </div>
      ...
      {/* Agreement - clickable label */}
      <label htmlFor="agreement-full" className="flex items-start gap-3 cursor-pointer group">
        <input
          type="checkbox"
          id="agreement-full"
          checked={formData.agreement}
