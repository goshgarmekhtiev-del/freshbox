...
const OrderForm: React.FC<OrderFormProps> = ({ cart, onSubmit: _onSubmit, onOrderComplete, onUpdateQty, onRemove }) => {
  ...
  return (
    <main 
      ...
      className={`min-h-screen bg-gradient-to-br from-[#F2FFD9] to-[#E3FFB5] reveal ${sectionVisible ? 'reveal-visible' : ''}`}
    >
      <div className="mx-auto max-w-6xl px-4 py-12 lg:py-16">
        <div className="grid gap-6 lg:grid-cols-[minmax(340px,400px)_minmax(0,1fr)] items-start">
          ...
          {/* Right Column - Form */}
          <section className="rounded-3xl bg-white/90 backdrop-blur-sm p-6 lg:p-8 shadow-xl space-y-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="p-5 rounded-2xl bg-gradient-to-br from-amber-50/50 to-orange-50/50 border border-amber-100 space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <h4 className="text-xl font-black text-brand-text">Доставка</h4>
                </div>
