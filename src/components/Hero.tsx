...
import { Button, ResponsiveImage, ImageWithPlaceholder } from './ui';
...
const Hero: React.FC = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-50 via-brand-accent-light to-lime-50 overflow-hidden pt-24 pb-20">
      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-20 xl:px-24 relative z-10">
        <div className="grid lg:grid-cols-2 gap-20 lg:gap-28 xl:gap-32 items-center">
          ...
          <div ref={heroRef as React.RefObject<HTMLDivElement>} className={`space-y-10 text-center lg:text-left reveal reveal-fade-up ${heroVisible ? 'reveal-visible' : ''}`}>
            ...
            <h1 className="text-5xl md:text-6xl font-black leading-tight text-brand-text tracking-tighter">
              Fresh.
              <span className="block mt-3 text-transparent bg-clip-text bg-gradient-to-r from-brand-accent via-brand-accent-dark to-brand-yellow">
                Juicy.
              </span>
              <span className="block mt-3 text-transparent bg-clip-text bg-gradient-to-r from-brand-green via-brand-green to-brand-yellow">
                Yours.
              </span>
            </h1>
            
            {/* Clean, Spacious Description - Softer Subheadline */}
            <p className="text-lg font-medium text-brand-text-soft max-w-2xl mx-auto lg:mx-0 leading-relaxed">
              Handpicked premium fruit boxes.
              <span className="block mt-3 text-brand-accent font-semibold bg-gradient-to-r from-brand-accent to-brand-accent-dark text-transparent bg-clip-text">
            ...
            <div className="flex items-center justify-center lg:justify-start gap-8 pt-8">
               <div className="flex -space-x-5">
                  <div className="w-16 h-16 rounded-full border-4 border-white shadow-[--shadow-soft] overflow-hidden ring-2 ring-brand-accent-light">
                    <ResponsiveImage
